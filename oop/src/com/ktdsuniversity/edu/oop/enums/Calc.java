...
public class Calc {
	...
	/**
	 * type에 전달된 연산의 종류에 따라서 num1과 num2를 연산하고 결과를 출력한다
	 * @param type 연산의 종류 (Calc.ADD, Calc.SUB, Calc.MUL, Calc.DIV)
	 * @param num1
	 * @param num2
	 */
	public void calc(int type, int num1, int num2) {
		if (type == ADD) {
			...
			("연산의 종류가 잘못되었습니다. Calc.ADD, Calc.SUB, Calc.MUL, Calc.DIV 중 하나를 선택하세요.");
		}
	}
...
//		calc.calc(DIV, 20, 3);
		...
		calc.computeNumbers(CalcType.MUL, 40, 100);
